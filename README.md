...
1. Download the environment from one of the links below.  Please select obnly the environment that matches your operating system:
...
2. Place the file in the `env` directory. 
...
Follow the instructions in `Continuous_Control.ipynb` to start training your agent!
